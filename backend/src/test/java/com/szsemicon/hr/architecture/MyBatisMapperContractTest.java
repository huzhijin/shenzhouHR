...
class MyBatisMapperContractTest {
    ...
    void parsesEveryMapperAndRegistersTheFirstStageQueries() throws Exception {
        ...
        List<String> mapperResources = List.of(
                ...
                "mappers/PunchExemptionMapper.xml",
                ...
                "mappers/EmployeeDeliBindingMapper.xml",
                ...
                "mappers/PunchImportCommandMapper.xml",
                "mappers/IdentityEffectiveFromCutoverMapper.xml");
        ...
        assertThat(configuration.getMappedStatementNames())
                .contains(
                        ...
                        "com.szsemicon.hr.employee.infrastructure.persistence.EmployeeReadMapper.canAccessEmployee",
                        "com.szsemicon.hr.employee.infrastructure.persistence.PunchExemptionMapper.hasStandingExemption",
                ...
                "com.szsemicon.hr.attendance.infrastructure.persistence.AttendancePolicyMapper.hasOtherFamily",
                        ...
                        "com.szsemicon.hr.evidenceingestion.infrastructure.persistence.AttendanceEvidenceMapper.findReplayStateBySourceIdentity",
                        "com.szsemicon.hr.evidenceingestion.infrastructure.persistence.EmployeeDeliBindingMapper.findEmployeeIdByNumber",
                        "com.szsemicon.hr.evidenceingestion.infrastructure.persistence.EmployeeDeliBindingMapper.listCurrentRoster",
                        "com.szsemicon.hr.evidenceingestion.infrastructure.persistence.EmployeeDeliBindingMapper.findCurrentBindingId",
                        "com.szsemicon.hr.evidenceingestion.infrastructure.persistence.EmployeeDeliBindingMapper.findEmployeeIdByDeliPersonId",
                        "com.szsemicon.hr.evidenceingestion.infrastructure.persistence.EmployeeDeliBindingMapper.insertBinding",
                        "com.szsemicon.hr.evidenceingestion.infrastructure.persistence.EmployeeDeliBindingMapper.updateCurrentBinding",
                        "com.szsemicon.hr.evidenceingestion.infrastructure.persistence.EmployeeDeliBindingMapper.insertRevision",
                        ...
                        "com.szsemicon.hr.evidenceingestion.infrastructure.persistence.AttendanceEvidenceMapper.countEvidenceLink",
                        ...
                        "com.szsemicon.hr.evidenceingestion.infrastructure.persistence.AttendanceEvidenceMapper.findOaAttendanceDocumentId",
                        "com.szsemicon.hr.evidenceingestion.infrastructure.persistence.AttendanceEvidenceMapper.countOaAttendanceDocumentContext",
