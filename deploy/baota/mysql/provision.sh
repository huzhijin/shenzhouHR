...
OA_MYSQL_JDBC_URL=jdbc:mysql://192.168.2.169:3308/szoa?useUnicode=true&characterEncoding=utf8&serverTimezone=Asia/Shanghai&sslMode=DISABLED&allowPublicKeyRetrieval=true
OA_MYSQL_USERNAME=kaoqin2026
OA_MYSQL_PASSWORD=Kaoqin2026@it@
